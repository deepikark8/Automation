...
public class TC_28_CheckMycontacts extends ReusableMethods {
...
//		  WebDriverManager.firefoxdriver().setup();
		...
		WebElement Mycont_view = driver.findElement(By.xpath("//select[@id='fcf']"));
		//Select dropdown = new Select(Mycont_view);
	    selectByVisibleText(Mycont_view, "My Contacts");
