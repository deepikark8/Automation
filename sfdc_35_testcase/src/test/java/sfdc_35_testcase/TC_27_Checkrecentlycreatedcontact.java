...
public class TC_27_Checkrecentlycreatedcontact extends ReusableMethods {
...
//		  WebDriverManager.firefoxdriver().setup();
		...
		WebElement Rec_Created = driver.findElement(By.xpath("//select[@id='hotlist_mode']"));
		Thread.sleep(3000);
		//Select dropdown = new Select(driver.findElement(By.xpath("//select[@id='hotlist_mode']")));
		selectByVisibleText(Rec_Created, "Recently Created");
		driver.close();
